            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 3rem; max-width: none; width: 100%;">
                <div>
                    ...
                    <ul>
                        ...
                        <li>Overall GPA: 4.19/4.3 (4.0/4.0)</li>
                        <li>Rank: Top 10%</li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul>
                        <li>iDEA-iSAIL Lab, Research Intern, <span class="date">Jul 2026 - Present</span></li>
                    ...
                    <h2>Work Roles</h2>
                    <ul>
                        <li>Sprout Project Program C++ Class, Lecturer and Project Manager, <span class="date">Nov 2023 - Jul 2026</span></li>
                        <li>Network Administration Team, DNS Group Chief, <span class="date">Oct 2024 - Jun 2026</span></li>
                        <li>Data Structure and Algorithm, Judge Admin, <span class="date">Feb 2026 - Jun 2026</span></li>
